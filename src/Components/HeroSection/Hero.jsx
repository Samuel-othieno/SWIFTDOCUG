      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight text-blue-100 sm:text-6xl">Step into a realm of convenience, expertise, and personalized care</h2>
           
            <p className="mt-6 text-lg leading-8 text-white">Uganda’s health care system is ranked in 149th place out of 191 countries in the world by WHO. There is roughly one doctor per 1,000 people and its population spends 7.2% of its GDP on keeping healthy. MoH research states that 70% of Ugandans who seek medical services are dissatisfied due to long queues in the health facilities, poor customer care management, and long distances between patients and medical facilities. Help us change these stats!</p>
          </div>
