...
export function FeaturesCards() {
  ...
  return (
    <Container
      size="lg"
      py="sm"
      className="max-w-[95%] rounded-xl mb-6"
    >
      ...
      <p className="mt-4 text-sm sm:text-lg leading-8 text-black">
        We understand the importance of your time and well-being. With SwiftDoc,
        quality healthcare is at your fingertips giving you the freedom to
        prioritize your health without compromising your schedule.
      </p>
