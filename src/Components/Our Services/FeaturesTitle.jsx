...
const features = [
  {
    ...
    description:
      "Connect with top-tier healthcare professionals from the comfort of your home. Expert advice, just a click away.",
  },
  {
    title: "Prescription Deliveries",
    description:
      "Skip the pharmacy queues! Enjoy the convenience of having your medications delivered right to your doorstep.",
  },
  {
